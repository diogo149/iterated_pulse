...
from SphericalOptimizer import SphericalOptimizer, StepPostProcessOptimizer
...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        # download synthesis.py
        # https://drive.google.com/uc?id=1TCViX1YpQyRsklTVYEJwdbmK91vklCo8
        self.synthesis.load_state_dict(torch.load("synthesis.pt"))
    ...
    def forward(
        ...
        **kwargs,
        ...
        if var_list_initial_values is not None:
            ...
            with torch.no_grad():
                for var, initial_value in zip(var_list, var_list_initial_values):
        ...
        if step_postprocess is None:
            ...
            opt = StepPostProcessOptimizer(
                opt_func, var_list, step_postprocess=step_postprocess, lr=learning_rate
            )
